      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative mx-auto flex w-full max-w-[1200px] items-center justify-center">
          <button
            onClick={prevSlide}
            disabled={active === 0}
            className={`absolute left-2 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-[#e8e1da] bg-[#ffffff] text-[#1e1c1a] shadow-xl transition-all active:scale-95 sm:left-4 md:left-[27%] ${
          ...
          <button
            ...
            className={`absolute right-2 z-50 flex h-10 w-10 items-center justify-center rounded-full border border-[#e8e1da] bg-[#ffffff] text-[#1e1c1a] shadow-xl transition-all active:scale-95 sm:right-4 md:right-[27%] ${
